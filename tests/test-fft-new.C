...
int main (int argc, char *argv[]) {
	...
	/* Test with Modular<double, double>, and a 22-bit prime and k=10 */
	pass &= test_one_modular_implem<double, double> (22, 10, seed);

	/* Test with Modular<uint16_t,uint32_t>, and 11-bit prime and k=7 */
	pass &= test_one_modular_implem<uint16_t, uint32_t> (11, 7, seed);
	...
	pass &= test_one_modular_implem<uint64_t, uint128_t> (59, 11, seed);
#endif

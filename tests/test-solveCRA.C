...
static bool checkResult(const Field& F, Matrix& A, BlasVector<Field>& B, BlasVector<Field>& X, typename Field::Element& d)
{
...
/////////////////////////////////////////////////////
template <class Field>
bool test_with_field(BlasVector<Field>& X2, BlasMatrix<Field>& A, BlasVector<Field>& B, int bits
...
/////////////////////////////////////////////////////
template <class Field>
void prepare_data_with_field(size_t bits, int seed, BlasVector<Field>& X2, BlasMatrix<Field>& A, BlasVector<Field>& B
...
/////////////////////////////////////////////////////
template <class Field>
void update_input(BlasMatrix<Field>& A, BlasVector<Field>& B, BlasVector<Field>& X2, int& seed, int q, size_t& n, size_t ni,
                  size_t& bits, size_t bitsize, bool& peak
#ifdef __LINBOX_HAVE_MPI
                  ,
                  Communicator* Cptr
#endif
                  )
{
    ...
    A.resize(n, n);
    X2.resize(A.coldim()), B.resize(A.coldim());
...
int main(int argc, char** argv)
{
    ...
    Argument args[] = {{'n', "-n N", "Set column and row dimension of test matrices to N.", TYPE_INT, &ni},

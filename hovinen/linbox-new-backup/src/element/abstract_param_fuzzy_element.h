/* File: src/library/objects/element/abstract_param_fuzzy_element.h
 * Author: William Turner for the LinBox group
 */

#ifndef _ABSTRACT_PARAM_FUZZY_ELEMENT_
#define _ABSTRACT_PARAM_FUZZY_ELEMENT_
...
{ 
  ...
  /** Abstract parameteric fuzzy LinBox field element.
   ...
   * their difference is less than a fuzz value.
   *
   * @see abstract_param_fuzzy
   */
  class abstract_param_fuzzy_element : public Element_abstract
  {
  public:

    /** Default Constructor.
     */
    abstract_param_fuzzy_element(void) {}

    /** Copy constructor.
     * Constructs abstract_param_fuzzy_element object by copying the element
     * it wraps.
     ...
     */
    abstract_param_fuzzy_element(const Element_abstract& E)
      : _value(static_cast<const abstract_param_fuzzy_element&>(E)._value) {}
  
    /** Constructor from an integer.
     * Sets residue to value supplied.
     * @param value constant reference to integer
     */
    abstract_param_fuzzy_element(const integer& value) 
    ...
    { return new abstract_param_fuzzy_element(*this); }
  ...
  private:
    ...
    // Friend declarations
    friend abstract_param_fuzzy;
    friend abstract_param_fuzzy_randIter;

    /// Private integer for residue class
    double _value;

  }; // class abstract_param_fuzzy_element

} // namespace LinBox

#endif // _ABSTRACT_PARAM_FUZZY_ELEMENT_

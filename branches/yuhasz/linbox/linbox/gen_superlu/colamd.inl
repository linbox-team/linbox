...
)
{
    ...
    dense_row_count = static_cast<int>( MAX (0, MIN (knobs [COLAMD_DENSE_ROW] * n_col, n_col)) ) ; /* A. Duran */
    dense_col_count = static_cast<int>( MAX (0, MIN (knobs [COLAMD_DENSE_COL] * n_row, n_row)) ); /* A. Duran */

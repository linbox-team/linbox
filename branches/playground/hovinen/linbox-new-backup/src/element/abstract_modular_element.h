/* File: src/library/objects/element/abstract_modular_element.h
 * Author: William Turner for the LinBox group
 */

#ifndef _ABSTRACT_MODULAR_ELEMENT_
#define _ABSTRACT_MODULAR_ELEMENT_
...
{ 
   ...
   *
   * @see abstract_modular
   */
  class abstract_modular_element : public Element_abstract
  {
  public:

    /** Default Constructor.
     */
    abstract_modular_element(void) {}

    /** Copy constructor.
     * Constructs abstract_modular_element object by copying the element
     * it wraps.
     ...
     */
    abstract_modular_element(const Element_abstract& E)
    ...
    { return new abstract_modular_element(*this); }
...
#endif // _ABSTRACT_MODULAR_ELEMENT_

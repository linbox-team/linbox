...
void
gssv_rank(SuperMatrix<Field> *A, int *perm_c, int *perm_r, SuperMatrix<Field> *L,
      SuperMatrix<Field> *U, int *info, int *rank, Field& F)
{
/*
 * Purpose
 * =======
 ...
 */
	...
	*trans = 'T';
    ...
    // PrintStat( &SuperLUStat ); // A. Duran excluded
    StatFree();

...
panel_dfs (
	   ...
	   const int  w,           /* in */
	   const int  jcol,        /* in */
	   SuperMatrix<Field> *A,         /* in - original matrix */
	   int        *perm_r,     /* in */
	   int        *nseg,	   /* out */
	   typename Field::Element *dense, /* out */
	   int        *panel_lsub, /* out */
	   int        *segrep,     /* out */
	   int        *repfnz,     /* out */
	   int        *xprune,     /* out */
 ...
 */
  ...
  typename Field::Element   *dense_col;  /* start of each column in the panel */

...
// typedef int shortint; // A. Duran 11/8/02  I changed every shortint to int
...
/* Subroutine */ int genmmd_(int *neqns, int *xadj, int *adjncy, 
	...
	int *nofsub)
{
    ...
    extern /* Subroutine */ int mmdelm_(int *, int *, int *, 
	    int *, int *, int *, int *, int *, 
	    int *, int *, int *), mmdupd_(int *, int *, 
	    int *, int *, int *, int *, int *, int 
	    *, int *, int *, int *, int *, int *, 
	    int *), mmdint_(int *, int *, int *, int *, 
	    int *, int *, int *, int *, int *), 
	    mmdnum_(int *, int *, int *, int *);
...
/* Subroutine */ int mmdint_(int *neqns, int *xadj, int *adjncy, 
...
/* Subroutine */ int mmdelm_(int *mdnode, int *xadj, int *adjncy,
	 int *dhead, int *dforw, int *dbakw, int *qsize, 
...
/* Subroutine */ int mmdnum_(int *neqns, int *perm, int *invp, 
	int *qsize)
{
    /* System generated locals */
    int i__1;

...
/**
 * ConferenceEntry
 * Extension of Entry class, implements special handling rules of ConferenceEntry BibTeX entry
 *
 */
public class ConferenceEntry extends Entry {
	 ...
	 *
	 */
	ConferenceEntry(BibtexEntry entry);
	 ...
	 *
	 */
	public class ConferenceEntry(Entry entry);

...
Integer  Integer::GMPGcd(const Integer& a, const Integer& b)
                                  //Integer& u, Integer& v)
{
...
Integer&  Integer::GMPGcd(Integer& g, const Integer& a, const Integer& b)
                                  //Integer& u, Integer& v)
{
  mpz_gcd( (mpz_ptr)&(g.gmp_rep), (mpz_ptr)&(a.gmp_rep), (mpz_ptr)&(b.gmp_rep) ) ;
  if (g.priv_sign() <0) return negin(g);
  return g ;
}
...
// ==========================================================================
// Computes and returns the gcd of the two integers a and b.
// Switch to different methods along the size of the input arguments
Integer  gcd(const Integer& a, const Integer& b)
{
  if (&a == &b) return a ;
  return Integer::GMPGcd(a,b) ;
}

Integer&  gcd(Integer& g, const Integer& a, const Integer& b)
{
  if (&a == &b) return g=a ;
  return Integer::GMPGcd(g,a,b) ;
}

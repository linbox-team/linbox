/* File: src/library/objects/random/abstract_modular_randiter.h
 * Author: William J Turner for the LinBox group
 */

#ifndef _ABSTRACT_MODULAR_RANDITER_
#define _ABSTRACT_MODULAR_RANDITER_
...
{ 
   ...
   */
  class abstract_modular_randIter : public RandIter_abstract
  {
  public:
     ...
     *             generator (default = 0)
     */
    abstract_modular_randIter(const abstract_modular& F, 
    ...
    } // abstract_modular_randIter(const abstract_modular&, ...)

    /** Copy constructor.
     * Constructs abstract_modular_randIter object by copying the random field
     * element generator.
     * This is required to allow generator objects to be passed by value
     * into functions.
     * @param  R abstract_modular_randIter object.
     */
    abstract_modular_randIter(const abstract_modular_randIter& R) 
     ...
     */
    ~abstract_modular_randIter() {}
    
    /** Assignment operator.
     * Assigns abstract_modular_randIter object R to generator.
     * Required by abstract base class.
     * @param  R abstract_modular_randIter object.
     */
    RandIter_abstract& operator=(const RandIter_abstract& R)
    {
      ...
      {
	_size = static_cast<const abstract_modular_randIter&>(R)._size;
	_seed = static_cast<const abstract_modular_randIter&>(R)._seed;
	_random = static_cast<const abstract_modular_randIter&>(R)._random;
	_loops = static_cast<const abstract_modular_randIter&>(R)._loops;
      }

      _randIter = _random.begin() 
	+ (static_cast<const abstract_modular_randIter&>(R)._randIter
	   - static_cast<const abstract_modular_randIter&>(R)._random.begin());
    ...
    { 
      return new 
	abstract_modular_randIter(static_cast<const abstract_modular&>(F),
				 size,
				 seed);
    ...
    { return new abstract_modular_randIter(*this); }
...
#endif // _ABSTRACT_MODULAR_RANDITER_

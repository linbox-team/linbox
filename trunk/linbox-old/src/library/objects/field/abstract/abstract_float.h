/* File: src/library/objects/field/abstract_float.h
 * Author: William Turner for the LinBox group
 */

#ifndef _ABSTRACT_FLOAT_
#define _ABSTRACT_FLOAT_
...
{ 
   ...
   * of the abstract base class.  This class implements a fields of floats 
   * through a private float members of the element class.
   */
  class abstract_float : public Field_abstract
  {
  public:
    ...
    /** Copy constructor.
     * Constructs abstract_float object by copying the field.
     * This is required to allow field objects to be passed by value
     * into functions.
     * @param  F abstract_float object.
     */
    abstract_float(const abstract_float& F) {}
     ...
     */
    Field_abstract* clone(void) const { return new abstract_float(*this); }
   ...
   /** Conversion of field base element to a template class T.
    ...
    { 
      return 
	x = static_cast<integer>(floor(static_cast<const abstract_float_element&>(y)._elem)); 
    }
    ...
    {
      return static_cast<const abstract_float_element&>(x)._elem
		== static_cast<const abstract_float_element&>(y)._elem;
    }
  			  ...
  			  const Element_abstract& z) const
    {
      static_cast<abstract_float_element&>(x)._elem
	= static_cast<const abstract_float_element&>(y)._elem
		+ static_cast<const abstract_float_element&>(z)._elem;
      return x;
    }
    ...
    {
      static_cast<abstract_float_element&>(x)._elem
	= 1 / static_cast<const abstract_float_element&>(y)._elem;
      return x;
    }
    ...
    Element_abstract& axpy(Element_abstract& r, 
			   ...
			   const Element_abstract& y) const
    { 
      static_cast<abstract_float_element&>(r)._elem
	= static_cast<const abstract_float_element&>(a)._elem
		* static_cast<const abstract_float_element&>(x)._elem
		+ static_cast<const abstract_float_element&>(y)._elem;
      return r;
    }
    ...
    { return static_cast<const abstract_float_element&>(x)._elem == 0; }
    ...
    { return static_cast<const abstract_float_element&>(x)._elem == 1; }
	...
	*= static_cast<const abstract_float_element&>(y)._elem;
    ...
    {
      static_cast<abstract_float_element&>(x)._elem
	= 1 / static_cast<abstract_float_element&>(x)._elem;
      return x;
    }
     ...
     */
    ostream& write(ostream& os) const { return os << "Abstract float field"; }
    ...
    { return os << static_cast<const abstract_float_element&>(x)._elem; }
    ...
    { return is >> static_cast<abstract_float_element&>(x)._elem; }

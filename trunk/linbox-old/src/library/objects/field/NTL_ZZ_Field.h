/* File: src/library/objects/field/NTL_ZZ_Field.h
 * Author: Li Chen for the LinBox group
 */

#ifndef _NTL_ZZ_Field_
#define _NTL_ZZ_Field_
...
{ 
  ...
  public:
    ...
    /** Assignment operator.
     */
    NTL_ZZ_Field& operator= (const NTL_ZZ_Field& F){return *this;}
   ...
   /** Conversion of field element to an integer.
     ...
     */
    integer& convert(integer& x, const element& y) const{return x = -1;}

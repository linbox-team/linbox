...
public:
        //-- Constructors
    MasseyDom(unsigned long ett_default = DEFAULT_EARLY_TERM_THRESHOLD) 
            : _container(), 
              _domain(), 
    ...
    MasseyDom(const Self_t& M, unsigned long ett_default = DEFAULT_EARLY_TERM_THRESHOLD) 
    ...
    MasseyDom(Sequence_t * D, unsigned long ett_default = DEFAULT_EARLY_TERM_THRESHOLD) 
            : _container(D), 
              _domain(D->getdomain()), 
              _Comm(PRINT_NOTHING,PRINT_NOTHING),
              EARLY_TERM_THRESHOLD( ett_default )
    ...
    MasseyDom(Sequence_t * MD, const Domain_t& D, unsigned long ett_default = DEFAULT_EARLY_TERM_THRESHOLD) 
       ...
       //-- with Commentator
    MasseyDom(const Commentator& C, unsigned long ett_default = DEFAULT_EARLY_TERM_THRESHOLD) 
            : _container(), 
              _domain(), 
              _Comm(C) ,
              EARLY_TERM_THRESHOLD( ett_default )
    ...
    MasseyDom(const Commentator& C, Sequence_t * D, unsigned long ett_default = DEFAULT_EARLY_TERM_THRESHOLD) 
            : _container(D), 
              _domain(D->getdomain()), 
              _Comm(C) ,
              EARLY_TERM_THRESHOLD( ett_default )

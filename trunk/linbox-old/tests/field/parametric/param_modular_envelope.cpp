/* File: src/examples/field/unparametric/param_modular_envelope.cpp
 * Author: William Turner
 */

#include "test_param_modular_envelope.h"
...
int main(int argc, char* argv[])
{
  ...
  T.test<test_linbox::field_categories::param_modular_envelope_tag>();

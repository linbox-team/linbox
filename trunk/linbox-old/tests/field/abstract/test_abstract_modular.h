...
#ifndef _TEST_ABSTRACT_MODULAR_
#define _TEST_ABSTRACT_MODULAR_
...
// Specialization of setup_field for abstract_modular
template <> 
bool test_linbox::test<test_linbox::field_categories::abstract_modular_tag>(void) const
{

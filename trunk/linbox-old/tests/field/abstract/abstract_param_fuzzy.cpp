/* File: src/examples/field/abstract/abstract_param_fuzzy.cpp
 * Author: William Turner
 */

#include "test_abstract_param_fuzzy.h"
...
int main(int argc, char* argv[])
{
  ...
  T.test<test_linbox::field_categories::abstract_param_fuzzy_tag>();

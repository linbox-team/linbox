/* File:	tests/BlackBox/transpose.h
...
int main(void)
{
	...
	cout << "Enter a sparsemat matrix:" << endl;
	...
	cout << "Enter a vector to be multiplied by the transpose matrix." << endl
	...
	LinBox::Transpose<Vector1> T1(&S1);
	LinBox::Blackbox_archetype<Vector1>& A1 = T1;
	...
	LinBox::Transpose<Vector2> T2(&S2);
	LinBox::Blackbox_archetype<Vector2>& A2 = T2;
	...
	LinBox::Transpose<Vector3> T3(&S3);
	LinBox::Blackbox_archetype<Vector3>& A3 = T3;

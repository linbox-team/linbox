/* File:	tests/BlackBox/hilbert.h
 * Author:	William J. Turner for the LinBox group
 *
 * Run tests on matrix Hilbert
 */
...
int main(void)
{
	...
	cout << "What is the size of the Hilbert matrix to create? ";

	size_t n;
	cin >> n;

	cout << "The size of the Hilbert matrix is " << n << endl;
	...
	cout << "Enter a vector to be multiplied by the hilbert matrix." << endl
	...
	LinBox::hilbert<Field, Vector1> H1(F,n);
	LinBox::Blackbox_archetype<Vector1>& A1 = H1;
	...
	LinBox::hilbert<Field, Vector2> H2(F,n);
	LinBox::Blackbox_archetype<Vector2>& A2 = H2;
	...
	LinBox::hilbert<Field, Vector3> H3(F,n);
	LinBox::Blackbox_archetype<Vector3>& A3 = H3;

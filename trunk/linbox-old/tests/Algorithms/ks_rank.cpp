/* File:	tests/Algorithms/ks_rank.h
 * Author:	William J. Turner for the LinBox group
 *
 * Run tests on Kaltofen-Saunders rank algorithm
 */
...
int main(void)
{
	...
	cout << "Input a square matrix of which to find the rank:" << endl;
	LinBox::sparsemat<Field, Row, Vector>
		A(*LinBox::newSparsemat<Field, Row>(F));

	if (A.rowdim() != A.coldim())
	{
		cout << "The matrix is not square; no rank found." << endl;
		return false;
	}
	...
	cout << "The rank is " << LinBox::ks_rank(F, A, r) << endl;

...
if test x$givaro_prefix != x; then
        LD_LIBRARY_PATH=$givaro_prefix/lib:$LD_LIBRARY_PATH
	export LD_LIBRARY_PATH
        CPLUS_INCLUDE_PATH=$givaro_prefix/include:$CPLUS_INCLUDE_PATH
	export CPLUS_INCLUDE_PATH

	AC_SUBST(givaro_prefix)
...
echo GIVARO IS AT ............. $givaro_prefix
dnl Check for existence

AC_CHECK_LIB(givaro, GetTime,
		[echo givaro check succeeded],[echo givaro check for GetTime failed])

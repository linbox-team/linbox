...
namespace LinBox
{
	...
	template < class _Matrix >
	BlasSubmatrix<_Matrix>::BlasSubmatrix (const BlasSubmatrix<_Matrix> &SM,
						size_t row,
						size_t col,
						size_t Rowdim,
						size_t Coldim) :
	...
	template < class _Matrix >
	BlasSubmatrix<_Matrix>& BlasSubmatrix<_Matrix>::submatrix(const BlasSubmatrix<_Matrix> &SM,
	...
	template < class _Matrix >
	BlasSubmatrix<_Matrix> &BlasSubmatrix<_Matrix>::swap( BlasSubmatrix<_Matrix> & B)
	{
...
namespace LinBox
{
						     ...
						     LINBOX_enum (LinBoxTag::Format) f ) const
	{
		...
		ConstRowIterator p;
		switch(f) {
		case (LinBoxTag::Format::FormatPlain) : /*  raw output */
			{
				integer c;
				int wid;
			...
			break;
		case (LinBoxTag::Format::FormatMaple) : /*  maple format */
			{
			...
			break;
		case (LinBoxTag::Format::FormatHTML) : /*  HTML format */
			{
			...
			break;
		case (LinBoxTag::Format::FormatLaTeX) : /*  LaTex format */
			{

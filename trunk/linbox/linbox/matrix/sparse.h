...
namespace LinBox
{
	...
	public:
		...
		*/
		...
		struct rebind {
			typedef SparseMatrix<_Tp1, _R1, Trait> other;
...
#include "linbox/matrix/sparse-sequence-vector.h"
#include "linbox/matrix/sparse-parallel-vector.h"
#include "linbox/matrix/sparse-associative-vector.h"

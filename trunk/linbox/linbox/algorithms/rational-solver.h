...
#define DEFAULT_MAXPRIMES 5
	...
	public:          
		...
		//generated by findRandomSolutionAndCertificate
		mutable VectorFraction<Ring>    lastCertificate;           //filled in if getCertificate is true
		mutable Integer                 lastZBNumer;               //filled in if getCertificate is true
		mutable Integer                 lastCertifiedDenFactor;    //filled in if getCertifiedDenFactor is true
	...
	public:
		 ...
		 */
		template<class IMatrix, class Vector1, class Vector2>
		SolverReturnStatus solve(Vector1& x, const IMatrix& A, const Vector2& b,const bool = false, int maxPrimes = DEFAULT_MAXPRIMES) const;
		 ...
		 */
		template<class IMatrix, class Vector1, class Vector2>
		SolverReturnStatus solveNonsingular(Vector1& x, const IMatrix& A, const Vector2& b, bool, int maxPrimes = DEFAULT_MAXPRIMES) const;         
		 ...
		 */	
		template<class IMatrix, class Vector1, class Vector2>
		SolverReturnStatus solveSingular(Vector1& x, const IMatrix& A, const Vector2& b, int maxPrimes = DEFAULT_MAXPRIMES) const;
		 ...
		 */	
		template<class IMatrix, class Vector1, class Vector2>
		SolverReturnStatus findRandomSolution(Vector1& x, const IMatrix& A, const Vector2& b, int maxPrimes = DEFAULT_MAXPRIMES) const;

		template <class IMatrix, class Vector1, class Vector2>	
		SolverReturnStatus findRandomSolutionAndCertificate (Vector1& answer, const IMatrix& A, const Vector2& b, const bool getCertificate, 
							       const bool getCertifiedDenFactor, int maxPrimes = DEFAULT_MAXPRIMES) const;

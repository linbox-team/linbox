...
FFLAS::ftrmm(const Field& F, const enum FFLAS_SIDE Side,
	...
	F.init(zero, 0UL);
	size_t nmax = FflasKmax (F, 0, zero);
	if ( Side==FflasLeft ){
		if ( Uplo==FflasUpper){
...
template<>
inline void 
FFLAS::ftrmmLeftUpNoTrans (const Modular<double>& F, const enum FFLAS_DIAG Diag, 
			   const size_t M, const size_t N,
...
template<>
inline void
FFLAS::ftrmmLeftUpTrans (const Modular<double>& F, const enum FFLAS_DIAG Diag, 
			 const size_t M, const size_t N,
			 const double * A, const size_t lda,
			 double * B, const size_t ldb,
			 const size_t nmax)
...
template<>
inline void 
FFLAS::ftrmmLeftLowTrans (const Modular<double>& F, const enum FFLAS_DIAG Diag, 
			  const size_t M, const size_t N,
			  const double * A, const size_t lda,
			  double * B, const size_t ldb,
			  const size_t nmax)
...
template<>
inline void
FFLAS::ftrmmRightUpTrans (const Modular<double>& F, const enum FFLAS_DIAG Diag, 
			  const size_t M, const size_t N,
			  const double * A, const size_t lda,
			  double * B, const size_t ldb,
			  const size_t nmax)
...
template<>
inline void
FFLAS::ftrmmRightLowTrans (const Modular<double>& F, const enum FFLAS_DIAG Diag, 
			   const size_t M, const size_t N,
			   const double * A, const size_t lda,
			   double * B, const size_t ldb, 
			   const size_t nmax)

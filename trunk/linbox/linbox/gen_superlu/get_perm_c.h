...
#include "linbox/gen_superlu/colamd.h"
//#include "linbox/gen_superlu/colamd.c" // A.Duran 11/8/02
#include "linbox/gen_superlu/superlu_timer.h" // A. Duran 11/8/02
#include "linbox/gen_superlu/mmd.h" // A. Duran 11/8/02
...
void
get_perm_c(int ispec, SuperMatrix<Field> *A, int *perm_c)
/*
 * Purpose
 * =======
 *
 ...
 */
{
    NCformat<Field> *Astore = (NCformat<Field> *)A->Store;

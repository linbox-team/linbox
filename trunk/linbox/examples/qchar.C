...
typedef Protected::DenseMatrix<Integers > Blackbox;
...
void i_vti_v(RBlackbox& Res, Protected::DenseMatrix<Rationals >& M, DVector& den, Integer& detPrec);
...
int main (int argc, char** argv)
{
	...
	Blackbox DM(Z,n,n);
	Protected::DenseMatrix<Rationals > In(Q,n,n);
	RBlackbox M(Q,n,n);
	DVector V(n,1);

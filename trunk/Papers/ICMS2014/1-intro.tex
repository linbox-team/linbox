...
%
\linbox is a \cpp template library for fast and exact linear algebra, designed with genericity
...
%
Added comprehensive benchmarking tools,\ldots
%
%
\par
%
...
\Cref{sec:container}, then the improved \emph{matrix multiplication} algorithms
in \Cref{sec:matmul} made by contributing special purpose matrix multiplication

\begin{table}[htbp]
	...
	\begin{tabular}{lcccccccccc}
		...
		\bottomrule \\
	\end{tabular}
	\caption[Evolution of the number of lines of codes in
	\linbox]{Evolution of the number of lines of code (loc, in thousands)
	in \linbox, \fflasffpack and \givaro (\td contains \givaro, \tdd

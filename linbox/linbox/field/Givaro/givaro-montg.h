...
namespace LinBox
{
	...
	/**
	 \brief wrapper of Givaro's Givaro::Montgomery< int32_t>.
	 \ingroup field

	 *  This class is a modular representation with a Givaro::Montgomery reduction
	 */
	class GivaroMontg : public Givaro::Montgomery< int32_t>, public FieldInterface {

	public:

		/** Element type.
		 *  This type is inherited from the Givaro class Givaro::Montgomery< int32_t>
		 */
		typedef Givaro::Montgomery< int32_t> Father_t ;
		...
		{
			return c=integer(static_cast<long>( Givaro::Montgomery< int32_t>::characteristic()));
		}

		long characteristic() const
		{
			return static_cast<long>( Givaro::Montgomery< int32_t>::characteristic());
		}
		...
		{
		       	return c=integer(static_cast<long>( Givaro::Montgomery< int32_t>::size()));
		}

		long cardinality() const
		{
			return static_cast<long>( Givaro::Montgomery< int32_t>::size());
		}
		...
		{
			return Givaro::Montgomery< int32_t>::init( x,long(y % (integer)_p));
		}

		Element& init(Element& x , const double y) const
		{
		       	return Givaro::Montgomery< int32_t>::init( x, y);
		}
		...
		{
			long tmp;
			//	return x = *(new integer(Montgomery< int32_t>::convert(tmp,y)));
			return x = integer( Givaro::Montgomery< int32_t>::convert(tmp,y));
		}

		double& convert(double& x, const Element& y) const
		{
			return Givaro::Montgomery< int32_t>::convert( x, y);
		}

#if 0 /*  isZero */
		bool isZero(const Element& x) const
		{
		       	return Givaro::Montgomery< int32_t>::isZero(x);
		}
#endif

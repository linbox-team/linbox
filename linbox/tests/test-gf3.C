...
int main (int argc, char **argv)
{
	...
	commentator().start("GF3 field test suite", "GF3");
	bool pass = true;
	...
	commentator().start ("Testing GF3", "main", 10);


	if ( not testField (F, "GF3"))
		pass = false;
	...
	commentator().stop("GF3 field test suite");
	return pass ? 0 : -1;
}

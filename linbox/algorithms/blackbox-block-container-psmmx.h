...
#ifndef __LINBOX_blackbox_block_container_psmmx_H
#define __LINBOX_blackbox_block_container_psmmx_H
...
namespace LinBox
{
	...
	class BlackboxBlockContainerPsmmx {
	public:
	...
	public:
		...
		void next() {
			...
			FFLAS::pfspmm(_F, _M, _b, _tmp, _b, _F.zero, _W, _b);
		}
		...
		class const_iterator {
			BlackboxBlockContainerPsmmx<Field, Blackbox> *_c;
		public:
			const_iterator() : _c(0){} // BB ??
			const_iterator(BlackboxBlockContainerPsmmx<Field, Blackbox> &C) :_c(&C) {}
...
#endif // __LINBOX_blackbox_block_container_psmmx_H

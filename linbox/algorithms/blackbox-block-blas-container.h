...
#ifndef __LINBOX_blackbox_block_blas_container_H
#define __LINBOX_blackbox_block_blas_container_H

#include "linbox/linbox-config.h"
#include "linbox/util/debug.h"

#include "linbox/algorithms/blackbox-block-blas-container-base.h"
...
namespace LinBox
{
	...
	class BlackboxBlockBlasContainer : public BlackboxBlockBlasContainerBase<_Field,_Blackbox> {
	public:
		...
		// Default constructor
		BlackboxBlockBlasContainer () {}

		// constructor of the sequence from a blackbox, a field and one block projection
		BlackboxBlockBlasContainer(const _Blackbox *D, const Field &F, const Block  &U0) :
			BlackboxBlockBlasContainerBase<Field,_Blackbox> (D, F, U0.rowdim(), U0.coldim()) , _blockW(D->rowdim(), U0.coldim()), _BMD(F)
		{
#ifdef _BBC_TIMING
			clearTimer();
			tSequence.clear();
		...
		BlackboxBlockBlasContainer(const _Blackbox *D, const Field &F, const Block &U0, const Block& V0) :
			BlackboxBlockBlasContainerBase<Field,_Blackbox> (D, F,U0.rowdim(), V0.coldim())
		...
		BlackboxBlockBlasContainer(const _Blackbox *D, const Field &F, size_t m, size_t n, size_t seed= (size_t)time(NULL)) :
			BlackboxBlockBlasContainerBase<Field, _Blackbox> (D, F, m, n,seed)
	 ...
	 */
	template<class _Field, class _Blackbox>
	class BlackboxBlockBlasContainerRecord : public BlackboxBlockBlasContainerBase<_Field,_Blackbox> {
	...
	public:
		...
		// Default constructor
		BlackboxBlockBlasContainerRecord () {}

		// constructor of the sequence from a blackbox, a field and one block projection
		BlackboxBlockBlasContainerRecord(const _Blackbox *D, const Field &F, const Block  &U0) :
		...
		// constructor of the sequence from a blackbox, a field and two blocks projection
		BlackboxBlockBlasContainerRecord(const _Blackbox *D, const Field &F, const Block &U0, const Block& V0, bool denseblock= true) :
			BlackboxBlockBlasContainerBase<Field,_Blackbox> (D, F,U0.rowdim(), V0.coldim())
		...
		//  constructor of the sequence from a blackbox, a field and two blocks random projection
		BlackboxBlockBlasContainerRecord(const _Blackbox *D, const Field &F, size_t m, size_t n, size_t seed= (size_t)time(NULL)) :
			BlackboxBlockBlasContainerBase<Field, _Blackbox> (D, F, m, n,seed),
...
#endif // __LINBOX_blackbox_block_blas_container_H

...
#ifndef __LINBOX_blackbox_block_blas_container_base_H
#define __LINBOX_blackbox_block_blas_container_base_H
...
#define MIN(a,b) ((a)<(b)?(a):(b))
	...
	class BlackboxBlockBlasContainerBase {
	public:
		...
		BlackboxBlockBlasContainerBase() {}

		// Sequence constructor from a blackbox and a field
		// cs set the size of the sequence
		BlackboxBlockBlasContainerBase(const Blackbox *BD, const Field &F, size_t m, size_t n, size_t seed=(size_t)time(NULL)) :
		...
		virtual ~BlackboxBlockBlasContainerBase(){}

		// iterator of the sequence
		class const_iterator {

		protected:
			BlackboxBlockBlasContainerBase<Field, Blackbox> &_c;

		public:
			const_iterator () {}

			const_iterator (BlackboxBlockBlasContainerBase<Field, Blackbox> &C) :
				_c (C)
			{}
...
#endif // __LINBOX_blackbox_block_blas_container_base_H

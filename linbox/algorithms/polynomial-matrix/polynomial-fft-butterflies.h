...
namespace LinBox {
	...
	public:
		...
		inline void Butterfly_DIT_mod4p (Element* ABCD, Element* EFGH,
			...
			// V3 = V1 mod 2P
			V3 = SimdMod::reduce (V1, P2);

			// V4 = V2 * W mod P
			V4 = SimdMod::mul_mod (V2,W,P,Wp);
		...
		inline void Butterfly_DIT_mod4p_firststeps (Element* ABCD, Element* EFGH,
			...
			T2 = SimdMod::mul_mod_half (T1, W, P, Wp);
		...
		inline void Butterfly_DIF_mod2p (Element* ABCD, Element* EFGH,
			...
			Wp = MemoryOp<Element,simd>::load(alphap);
			// V3 = V1 + V2 mod
			V3 = SimdMod::add_mod (V1,V2,P2);
			MemoryOp<Element,simd>::store(ABCD,V3);
			// V4 = (V1+(2P-V2))alpha mod 2P
			T = simd::sub(V2,P2);
			V4 = simd::sub(V1,T);

			T = SimdMod::mul_mod (V4,W,P,Wp);// T is the result
		...
		inline void Butterfly_DIF_mod2p_laststeps(Element* ABCD, Element* EFGH,
			...
			// V1 = V3 + V4 mod 2P
			// P2 = [2p 2p 2p 2p]
			V1 = SimdMod::add_mod (V3,V4,P2);
			// V2 = (V3+(2P-V4))alpha mod 2P
			V5 = simd::sub(V4,P2);
			V6 = simd::sub(V3,V5);
			V2 = SimdMod::reduce (V6, P2);
			// V4 = [D D H H]
			V4 = MemoryOp<Element,simd>::unpackhi4(V2,V2);

			// V3 = [* D * H]
			V3 = SimdMod::mul_mod_half (V4, W, P, Wp);
	...
	public:
		...
		inline void Butterfly_DIT_mod4p_firststeps (Element* ABCDEFGH, Element* IJKLMNOP,
			...
			// V3 = [* D * L * H * P]
			V3 = SimdMod::mul_mod_half (V5,alpha,P,alphap);
			...
			// V6= V3 mod 2P
			V6 = SimdMod::reduce (V3, P2);

			// V7= V4.beta mod p
			V7 = SimdMod::mul_mod (V4,beta,P,betap);
		...
		inline void Butterfly_DIF_mod2p_laststeps(Element* ABCDEFGH, Element* IJKLMNOP,
			...
			V5 = simd::sub(V4,P2);
			V6 = simd::sub(V3,V5);
			V7 = SimdMod::reduce (V6, P2);
			V2 = SimdMod::mul_mod (V7,alpha,P,alphap);
			...
			// V3 = [ * D * H * L * P]
			V3 = SimdMod::mul_mod_half (V4,beta,P,betap);
	...
	public:
		...
		inline void Butterfly_DIT (Element* ABCD, Element* EFGH, const Element* alpha, const vect_t& P, const vect_t& U) {
			...
			//Element tmp;
			T1 = SimdMod::mul_mod (W, V2, P, U);
			V2 = SimdMod::sub_mod (V1, T1, P);
			V1 = SimdMod::add_mod (V1, T1, P);
		...
		inline void Butterfly_DIT_firststeps (Element* ABCD, Element* EFGH, const vect_t& W, const vect_t& P, const vect_t& U) {
			...
			V3 = SimdMod::add_mod (V1,V2,P);
			V4 = SimdMod::sub_mod (V1,V2,P);
			...
			T1 = SimdMod::add_mod (V1,V2,P);
			T2 = SimdMod::sub_mod (V1,V2,P);
		...
		inline void Butterfly_DIF (Element* ABCD, Element* EFGH, const Element* alpha, const vect_t& P, const vect_t& U) {
			...
			T = V1;
			V1 = SimdMod::add_mod (V1, V2, P);
			V2 = SimdMod::sub_mod (T, V2, P);
			V2 = SimdMod::mul_mod (V2, W, P, U);
		...
		inline void Butterfly_DIF_laststeps(Element* ABCD, Element* EFGH, const vect_t& W, const vect_t& P, const vect_t& U) {
			...
			V1 = SimdMod::add_mod (V3,V4,P);
			V2 = SimdMod::sub_mod (V3,V4,P);

			// V4 = [D D H H]
			V4 = MemoryOp<Element,simd>::unpackhi4(V2,V2);

			V3 = SimdMod::mul_mod (V4, W, P, U);

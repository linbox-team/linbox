...
#ifndef __LINBOX_smith_form_kannan_bachem2_domain_H
#define __LINBOX_smith_form_kannan_bachem2_domain_H

namespace LinBox
{
	template<class Field>
	class SmithFormKannanBachem2Domain
	{
	public:
	...
	public:
		SmithFormKannanBachem2Domain(const Field &F) : _F(F), _MD(_F) {}
		SmithFormKannanBachem2Domain(const SmithFormKannanBachem2Domain &D) : _F(D._F), _MD(D._MD) {}
...
#endif // __LINBOX_smith_form_kannan_bachem2_domain_H

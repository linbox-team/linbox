...
#ifndef __LINBOX_frobenius_large_butterfly_H
#define __LINBOX_frobenius_large_butterfly_H
...
protected:
	...
	MatrixDom _MD;
public:
	FrobeniusLargeButterfly(const PolynomialRing &R) 
...
#endif //__LINBOX_frobenius_large_butterfly_H

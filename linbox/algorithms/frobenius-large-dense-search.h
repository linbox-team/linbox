/* linbox/algorithms/frobenius-large-dense-search.h
...
#ifndef __LINBOX_frobenius_large_dense_search_H
#define __LINBOX_frobenius_large_dense_search_H
...
// Dense preconditioner + exponential threshold search
// PolynomialRing = NTL_zz_pX or NTL_zz_pEX
template<class _PolynomialRing>
class FrobeniusLargeDenseSearch {
public:
...
public:
	FrobeniusLargeDenseSearch(const PolynomialRing &R)
...
#endif //__LINBOX_frobenius_large_dense_search_H

...
namespace LinBox {
    ...
    template <class X> void Communicator::ssend(X& b, int dest) { MPI_Ssend(&b, sizeof(X), MPI_BYTE, dest, 0, _mpi_comm); }
    ...
    template <class X> void Communicator::recv(X& b, int src)
    {

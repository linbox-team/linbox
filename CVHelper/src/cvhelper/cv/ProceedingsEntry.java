...
/**
 * ProceedingsEntry
 * Extension of Entry class, implements special handling rules of ProceedingsEntry BibTeX entry
 *
 */
public class ProceedingsEntry extends Entry {
	 ...
	 *
	 */
	ProceedingsEntry(BibtexEntry entry);
	 ...
	 *
	 */
	public class ProceedingsEntry(Entry entry);
	...
	public boolean isValid() {
		return super.isValid() && hasTitle() && hasYear();
	}

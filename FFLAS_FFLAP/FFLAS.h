...
//-----------------------------------------------------------------------------
	...
	//---------------------------------------------------------------------
	template<class Field>
	static void MatF2MatD_Triangular(Field& F,
					 typename DoubleDomain::element* S,
...
//---------------------------------------------------------------------
	...
	fscal( const Field& F, const size_t n, const typename Field::element alpha, 
	       typename Field::element * X, size_t incX){
...
//---------------------------------------------------------------------
	...
	fgemm( Field& F,
		...
		fgemm(F, ta, tb, m, n, k, alpha, A, lda, B, ldb,
		      beta, C, ldc, ws);
	}
...
#include "FFLAS/FFLAS_fgemm.inl"
#include "FFLAS/FFLAS_ftrsm.inl"
#include "FFLAS/FFLAS_ftrsv.inl"

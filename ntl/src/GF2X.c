...
void add(GF2X& x, const GF2X& a, const GF2X& b)
{
   ...
   if (sa == sb) {
      ...
      u_long *xp = x.xrep.elts();
      const u_long *ap = a.xrep.elts();
      const u_long *bp = b.xrep.elts();
...
inline
void mul1(u_long *c, u_long a, u_long b)
{
   u_long hi, lo;
   u_long A[4];
...
inline
void mul_half(u_long *c, u_long a, u_long b)
{
   u_long hi, lo;
   u_long A[4];
...
static
void mul2(u_long *c, const u_long *a, const u_long *b)
{
   u_long hs0, hs1;
   u_long hl2[2];
...
static
void mul3 (u_long *c, const u_long *a, const u_long *b)
{
   u_long hs0[2], hs1[2];
   u_long hl2[4];
...
static
void mul4(u_long *c, const u_long *a, const u_long *b)
{
   u_long hs0[2], hs1[2];
   u_long hl2[4];
...
static
void mul5 (u_long *c, const u_long *a, const u_long *b)
{
   u_long hs0[3], hs1[3];
   u_long hl2[6];
...
static
void mul6(u_long *c, const u_long *a, const u_long *b)
{
   u_long hs0[3], hs1[3];
   u_long hl2[6];
...
static
void mul7(u_long *c, const u_long *a, const u_long *b)
{
   u_long hs0[4], hs1[4];
   u_long hl2[8];
...
static
void mul8(u_long *c, const u_long *a, const u_long *b)
{
   u_long hs0[4], hs1[4];
   u_long hl2[8];
...
static
void KarMul(u_long *c, const u_long *a, const u_long *b, long len, u_long *stk)
{
   if (len <= 8) {
      switch (len) {
...
void mul(GF2X& c, const GF2X& a, const GF2X& b)
{
   ...
   do {
      ...
      { const u_long *t; t = ap; ap = bp + i; bp = t; }
...
inline void sqr1(u_long *c, u_long a)
{
   u_long hi, lo;
...

{
   ...
   for (i = 0; i < wn/2; i++) {
      u_long t; t = cp[i]; cp[i] = cp[wn-1-i]; cp[wn-1-i] = t;
   }

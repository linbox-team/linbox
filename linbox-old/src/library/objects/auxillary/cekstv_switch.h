...
template <class Field>
	inline LinBox::cekstv_switch<Field>
	::cekstv_switch(const Field& F, const typename Field::randIter& R)
: _F(F), _R(R)
{ 
#ifdef TRACE
	clog << "Called cekstv_switch constructor from random field element generator." << endl;
#endif // TRACE
...
template <class Field>
inline LinBox::cekstv_switch<Field>::cekstv_switch(
		const Field& F,
...
template <class Field> 
inline bool LinBox::cekstv_switch<Field>
::apply(

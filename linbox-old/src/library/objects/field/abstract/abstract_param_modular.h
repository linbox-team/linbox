  ...
  public:
   ...
   /** Conversion of field base element to a template class T.
    ...
    Element_abstract& axpy(Element_abstract& r, 
			   ...
			   const Element_abstract& y) const
    { 
      static_cast<abstract_param_modular_element&>(r)._residue
	= ( static_cast<const abstract_param_modular_element&>(a)._residue
		* static_cast<const abstract_param_modular_element&>(x)._residue
	    + static_cast<const abstract_param_modular_element&>(y)._residue )
	  % _modulus;

      if (static_cast<abstract_param_modular_element&>(r)._residue < 0)
	static_cast<abstract_param_modular_element&>(r)._residue += _modulus;

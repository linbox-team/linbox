...
//     try{
    ...
    SPBB MF( F );
    {
	    ...
	    unsigned long print = PRINT_NOTHING;
	    if (argc > 6) print = PRINT_EVERYTHING;
	
            MasseyDom< SzCBB >  WD(Commentator(print,print,2,4,EXPO_ESTIMATE), &TF );

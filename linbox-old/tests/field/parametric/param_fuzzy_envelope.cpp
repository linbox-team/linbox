/* File: src/examples/field/unparametric/param_fuzzy_envelope.cpp
 * Author: William Turner
 */

#include "test_param_fuzzy_envelope.h"
...
int main(int argc, char* argv[])
{
  ...
  T.test<test_linbox::field_categories::param_fuzzy_envelope_tag>();
